...
//global variables
//Map* main_map = set_active_map(0);
//Map* wand_map = set_active_map(1);
int b = 1;
int n = 0;
...
int main()
{
    ...
    //while(loop) {
        ...
        /*    uLCD.textbackground_color(BLACK);
            uLCD.text_string(" Would you like ",1,5,FONT_7X8,0xFFFF00);
            uLCD.text_string(" to play again? ",1,7,FONT_7X8,0xFFFF00);
            uLCD.text_string("NO",4,10,FONT_7X8,0xFFFF00);
            uLCD.text_string("YES",11,10,FONT_7X8,0xFFFF00);
            uLCD.filled_circle(35, 105, 7, RED);
            uLCD.filled_circle(87, 105, 7, RED);
